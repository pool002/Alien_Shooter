...
class Scoreboard():
    ...
    def __init__(self,game_settings,screen,stats):
        ...
        #Font settings for storing info
    ...
    def prep_high_score(self):
        ...
        self.high_score_rect.top=self.score_rect.top +2


    def prep_level(self):
        '''Turn the level into a rendered image'''
        self.level='Level: ' + str(self.stats.level)
        self.level_image=self.font.render(self.level,True,self.text_color,self.game_settings.bg_color)
